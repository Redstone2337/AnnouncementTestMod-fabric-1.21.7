...
public record BlazingFlameSwordComponent(boolean isDisplay) implements TooltipAppender {
    ...
    public void appendTooltip(Item.TooltipContext context, Consumer<Text> textConsumer, TooltipType type, ComponentsAccess components) {
        textConsumer.accept(Text.literal("由陨铁与火晶石锻造的神兵，剑身呈深红色，表面有流动的岩浆纹路。"));
        textConsumer.accept(Text.literal("剑柄由黑曜石制成，发着橙红色的光芒，仿佛握着一团永不熄灭的烈焰。"));
        textConsumer.accept(Text.literal("剑刃炽热通红，边缘隐约可见金色的火焰纹路。"));
        textConsumer.accept(Text.literal("动时会在空中留下火焰轨迹，剑尖处常有小火苗跳动。"));
        textConsumer.accept(Text.literal("整体散发着橙红色的光芒，仿佛握着一团永不熄灭的烈焰。"));
    }
}
